...
import { faFire, faClock, faTv, faDesktop } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className="bg-white rounded-lg p-4 sticky top-24">
        ...
        <nav id="sidebar-nav" className="flex flex-col space-y-2">
          <a
            ...
            className={`sidebar-link flex items-center px-3 py-2 rounded-md hover:bg-gray-100 ${
              sortBy === "likes" ? "active" : ""
            }`}
          >
        ...
        <nav
          id="sidebar-nav-res"
          className="flex flex-wrap gap-4" // Makes them side by side
        >
          <a
            href="#"
            onClick={(e) => {
              e.preventDefault();
              handleFilterClick("4k");
            }}
            className={`sidebar-link flex items-center px-3 py-2 rounded-md hover:bg-gray-100 ${
              activeFilter === "4k" ? "active" : ""
            }`}
          >
            <FontAwesomeIcon icon={faTv} className="w-5 h-5 text-purple-500" />
            <span className="ml-2">4K Wallpapers</span>
          </a>
          <a
            href="#"
            onClick={(e) => {
              e.preventDefault();
              handleFilterClick("hd");
            }}
            className={`sidebar-link flex items-center px-3 py-2 rounded-md hover:bg-gray-100 ${
              activeFilter === "hd" ? "active" : ""
            }`}
          >
            <FontAwesomeIcon icon={faDesktop} className="w-5 h-5 text-green-500" />
            <span className="ml-2">HD Wallpapers</span>
          </a>
        </nav>
      </div>
    </aside>
